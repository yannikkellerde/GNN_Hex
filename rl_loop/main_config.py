...
default_dir = os.path.abspath(os.path.join(base_path,"../data/RL/export/"))
...
main_config = {
    ...
    "pgn_train_dir": os.path.abspath(os.path.realpath(os.path.join(base_path, "../data/RL/pgn/train"))),
    "pgn_val_dir": os.path.abspath(os.path.realpath(os.path.join(base_path, "../data/RL/pgn/val"))),
    "pgn_test_dir": os.path.abspath(os.path.realpath(os.path.join(base_path, "../data/RL/pgn/test"))),
    "pgn_mate_in_one_dir": os.path.abspath(os.path.realpath(os.path.join(base_path, "../data/RL/pgn/mate_in_one"))),
    ...
    "rec_dir": os.path.abspath(os.path.realpath(os.path.join(base_path,"../data/RL/rec"))),
