...
def supervised_stuff():
    ...
    plt.plot(gao_df.index,gao_df["policy_rolling_val"],color="C2",alpha=1,label="Gao")
    ...
    plt.plot(cnn_df.index,cnn_df["policy_rolling_val"],color="C0",alpha=1,label="U-Net")
    ...
    plt.plot(gao_df.index,gao_df["value_acc_sign/val"],color="C2",alpha=0.2)
    plt.plot(gao_df.index,gao_df["value_rolling_val"],color="C2",alpha=1,label="Gao")
    ...
    plt.plot(cnn_df.index,cnn_df["value_rolling_val"],color="C0",alpha=1,label="U-Net")
