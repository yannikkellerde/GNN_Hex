...
default_train_hyperparams = dict(lr=0.002,batch_size=256,model_name="GCN_hex",epochs=200,policy_weighting=100)
...
def run_single_experiment(all_hyperparams):
    ...
    cached_model = cachify_gnn(model_map[all_hyperparams["model_type"]]) 
    model = PolicyValueGNN(cached_model,**model_hyperparams).to(device)
